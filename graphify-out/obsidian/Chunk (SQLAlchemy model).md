---
source_file: "app/models/chunk.py"
type: "code"
...
## Connections
- [[Base (DeclarativeBase)]] - `implements` [EXTRACTED]
- [[Document (SQLAlchemy model)]] - `shares_data_with` [EXTRACTED]
- [[create_all_tables()_1]] - `references` [EXTRACTED]
